...
randvar = np.loadtxt('../data/uni1.dat',dtype='double') + np.loadtxt('../data/uni2.dat',dtype='double')
...
plt.savefig('../../figs/ch2/tri_cdf.pdf')
plt.savefig('../../figs/ch2/tri_cdf.png')
...
plt.savefig('../../figs/ch2/tri_pdf.pdf')
plt.savefig('../../figs/ch2/tri_pdf.png')
